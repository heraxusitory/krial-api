export default {
  route: {
    module_pages: 'Модульные странницы',
    catalog: 'Каталог',
    article_sources: 'Текстовые материалы',
    news: 'Новости',
    training_n_events: 'Тренинги и мероприятия',
    articles: 'Статьи',
    articles_n_reviews: 'Статьи и обзоры',
    cases: 'Кейсы',
    standard_solutions: 'Типовые решения',
    dgu: 'ДГУ',
    dg_property_groups: 'Группы характеристик',
    dg_versions: 'Варианты исполнения',
    dg_products: 'Товары',
    ...
    dg_options_edit: 'Редактирование опци',
    ...
    marketing: 'Маркетинг',
    marketing_banners: 'Баннеры',
    marketing_banner_edit: 'Редактирование баннера',
    banners: 'Баннеры',
    banner_list: 'Список баннеров',
    banners_edit: 'Редактирование баннера',
    banner_types: 'Типы баннеров',
    banner_type_edit: 'Редактирование типа баннера',
    settings: 'Настройки',
    general_settings: 'Общие конфигурации',
    header_settings: 'Конфигурации шапки',
    footer_settings: 'Конфигурации подвала',
